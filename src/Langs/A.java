...
public class A {
    ...
    public static final int INDEX_SIZE = 42;
    ...
    public static final int SEPARATE = 48;
    public static final int TRANSLATE = 49;
    public static final int JOIN = 50;
    public static final int ADD_LIST = 51;
    public static final int ADD_DICTIONARY = 52;
    public static final int LIST = 53;
    public static final int DICTIONARY = 54;
